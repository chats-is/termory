...
Open
─────────────────────
New Session             ▸  termory                 ← up to 5 recent project dirs as
                             Claude Code               (disabled) group headers, each
                             Codex                     listing every INSTALLED CLI;
                           ─────────                   pick one → terminal opens in
                           chats                       the dir + that CLI launches fresh
                             Claude Code
                             …
─────────────────────
