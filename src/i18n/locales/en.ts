...
export const en = {
  ...
  "time.durDayOne": "{n} day",
  "time.durDayOther": "{n} days",
  "time.durHr": "{n} hr",
  "time.durMin": "{n} min",
  ...
  "stats.kpi.activeDays": "Active days",
  "stats.kpi.currentStreak": "Current streak",
  "stats.kpi.longestStreak": "Longest streak",
  "stats.kpi.peakHour": "Peak hour",
  "stats.kpi.favoriteModel": "Favorite model",
  "stats.streakDays": "{n}d",
  "stats.tokensChart": "Tokens",
  "stats.groupByType": "Type",
  "stats.groupByModel": "Model",
  "stats.othersBucket": "Others",
  ...
  "records.tryFilters": "Try a different source or project",
  ...
  "menu.migrateConfirmGemini": "Re-point this Gemini project's history to:\n{to}\n\nUpdates where `gemini --resume` finds it; the chat files themselves are not moved.",
  "menu.migrateConfirmOpencode": "Re-point these OpenCode sessions to:\n{to}\n\nUpdates how Termory groups them; `opencode --session` resumes by id regardless.",
  "menu.migrateConfirmGrok": "Move this Grok history to:\n{to}\n\nThe session files are moved on disk so `grok --resume` finds them in the new folder.",
  "menu.migrateSuccess": "Migrated {sessions} sessions + {memory} memory files",
  "menu.migrateSuccessCodex": "Migrated {sessions} sessions",
  "menu.migrateSuccessGemini": "Migrated {sessions} sessions",
  "menu.migrateSuccessOpencode": "Migrated {sessions} sessions",
  "menu.migrateSuccessGrok": "Migrated {sessions} sessions",
  ...
  "providers.upgradeFailed": "Couldn't upgrade {app}",
  "providers.upgradeRunItYourself": "You can run this in a terminal:",
  ...
  "providers.balanceRefresh": "Refresh balance",
  "providers.balanceDepleted": "This account can no longer spend",
  "providers.balanceCooldownHint": "Refreshed just now — try again in a moment",
  "providers.apiBackend": "API backend",
  "providers.apiBackendDefault": "Default",
  ...
  "help.extraModels": "The models this provider adds to OpenCode's picker — each becomes one entry. ID is the model id; name is the display label (defaults to the id if left blank).",
  "help.opencodeDefault": "Optional — the model OpenCode defaults to. Pick one of the models above; leave blank to set no default.",
  ...
  "providers.accountSwitchConfirm": "Switch the live login to {name}? This replaces the credential {cli} currently uses.",
  "providers.accountSwitchQuitClaudeHint": "Quit any running claude sessions first — a running instance may overwrite the switched login.",
  ...
  "install.openDownload": "Open download page",
  "install.docs": "Docs",
