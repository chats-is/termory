...
export const en = {
  ...
  "toast.accountTokenExpired": "Token refresh failed — use 'Add account' to re-authenticate.",
  ...
  "providers.accountsTitle": "Accounts",
  ...
  "providers.accountAlreadySaved": "The current login is already saved.",
  "providers.accountNoLogin": "No official login to save — sign in to the CLI first.",
  "providers.accountName": "Account name",
  "providers.accountNamePlaceholder": "e.g. Personal, Work",
  "providers.accountActive": "Active",
  "providers.accountSwitch": "Switch",
  "providers.accountUnsaved": "Unsaved",
  "providers.accountRename": "Rename",
  "providers.accountDelete": "Delete",
  "providers.accountSwitchTitle": "Switch account",
  "providers.accountSwitchConfirm": "Switch the live login to {name}? This replaces the credential the CLI currently uses.",
  "providers.accountSwitchWarnUnsaved": "The current login isn't saved — switching will overwrite it.",
  "providers.accountCurrentUnsaved": "The current login isn't saved yet.",
  ...
  "providers.accountKeyringWarning": "This CLI is set to store credentials in the system keyring ({mode}); switching here writes the file and may not take effect.",
