...
export const en = {
  ...
  "providers.apiBackendDefault": "Default (chat_completions)",
  ...
  "help.grokApiBackend": "The wire API each model entry uses — Grok's `api_backend`. Default leaves the field unset so Grok applies its own default (chat_completions).",
