...
export const zhHans: Record<MessageKey, string> = {
  ...
  "providers.aiGateways": "AI 网关",
  "providers.addGateway": "添加 AI 网关",
  "providers.deleteGateway": "删除 AI 网关",
  "providers.editGateway": "编辑 AI 网关",
  "providers.noGateways": "还没有 AI 网关",
  ...
  "providers.gwEmptyDesc": "添加一个 AI 网关:一个 base URL + 密钥。Termory 会检测它支持哪些 API 模式,并让你绑定到匹配的 CLI。",
  "providers.unnamedGateway": "(未命名网关)",
